...
// style files regexes
const cssRegex = /\.css$/;  // 公用样式
const cssModuleRegex = /\.module\.css$/;  //.module.css后缀文件 css module模块化 
const lessRegex = /\.less$/;
const lessModuleRegex = /\.module\.less$/;

// This is the production and development configuration.
// It is focused on developer experience, fast rebuilds, and a minimal bundle.
const webpackProdConfig = function (webpackEnv) {
  ...
  return {
    ...
    // ECMAScirpt5 中 Array 类中的 filter 方法使用目的是移除所有的 ”false“ 类型元素 
    output: {
      // The build folder.
